<template>
  <div class="parking-lot-container" ref="container">
    ...
    <!-- left -->
    <div id="carparkleft">
      <Car :number="n.number" v-for=" n in l1" :key="n" number-position="right" :has-car="n.isStop"></Car>
    </div>
    <div class="overlay"></div>
    <div id="carparkcenter">
      <Car :number="n.number" v-for=" n in l2" :key="n" number-position="left" :has-car="n.isStop"></Car>
    </div>
    <div id="carparkcenter2">
      <Car :number="n.number" v-for=" n in l3" :key="n" number-position="right" :has-car="n.isStop"></Car>
    </div>
    <div id="carparkright">
      <Car :number="n.number" v-for=" n in l4" :key="n" number-position="left" :has-car="n.isStop"></Car>
    </div>
    <div id="carparkright2">
      <Car :number="n.number" v-for=" n in l5" :key="n" number-position="right" :has-car="n.isStop"></Car>
    </div>
    <!-- right -->
    <div id="r1">
      <Car :number="n.number" v-for=" n in r1" :key="n" number-position="right" headerDirection="vertical"
        :has-car="n.isStop" numberPosition="rcenter"></Car>
    </div>

    <div id="r2">
      <Car :number="n.number" v-for=" n in r2" :key="n" number-position="right" headerDirection="vertical"
        :has-car="n.isStop" numberPosition="rright"></Car>
    </div>
    ...
    <div id="r12">
      <Car :number="n.number" v-for=" n in r12" :key="n" number-position="right" headerDirection="horizontal"
        :has-car="n.isStop" numberPosition="right"></Car>
    </div>
